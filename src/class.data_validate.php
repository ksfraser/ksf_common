...
class DataValidator {
     ...
     */
    public static function validateLength($data, $minLength, $maxLength) {
        return is_string($data) && strlen($data) >= $minLength && strlen($data) <= $maxLength;
    }

    /**
     * Validate if a value matches a specific data type.
     *
     * @param mixed $data The value to validate.
     * @param string $type The expected data type (e.g., 'int', 'string').
     * @return bool True if valid, false otherwise.
     */
    public static function validateType($data, $type) {
        switch ($type) {
            case 'int':
                return is_int($data);
            case 'string':
    ...
    /**
     * Check if all mandatory fields are set and non-empty.
     *
     * @param array $fields The list of mandatory fields.
     * @param object $object The object to check.
     * @return bool True if all mandatory fields are set, false otherwise.
     */
    public static function areMandatoryFieldsSet($fields, $object) {
