...
/**//*********************************************************
* This class used to be called file_download
*
**************************************************************/
class rest_file_download extends rest_interface
{
	protected $filename;
	protected $fp;
	protected $tmpdir;
...
/**//****************************************************
* The rest_file_download used to be called file_download.
*
* This is a temporary measure.
* @depreciated 
********************************************************/
class file_download extends rest_file_download
{
        function __construct(  )
        {
                parent::__construct(  );
