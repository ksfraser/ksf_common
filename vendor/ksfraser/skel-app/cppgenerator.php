...
function __construct($table)
{
	...
	$this->classfilename = $this->tablename . ".cpp"; 
...
//	$filestring .= "#define " . $this->tablename . "\n\n";
	...
	$filestring .= "class $this->tablename\n{\n";
/*20090308 KF Eventum issue #27 */
//Merge the various versions of the generator
...
//!#27
	$filestring .= "         private: char* observers;\n";
...
/*
		...
		foreach ($dbactions as $value)
		{
			...
			$funcstring2 .= "         {\n";
			$funcstring2 .= "         \tthis->Setdata( data );\n";
				//Eventum framework issue #35
			$funcstring2 .= "                 if ( is_callable( this->" . $this->tablename . "_Pre" . $res['column_name'] . $value . " ) )\n";
			$funcstring2 .= "	            return this->" . $this->tablename . "_Pre" . $res['column_name'] . $value . "( \$this );\n";
			...
			$funcstring2 .= "         \tthis->Setdata( data );\n";
				//Eventum framework issue #35
			$funcstring2 .= "                 if ( is_callable( this->" . $this->tablename . "_Post" . $res['column_name'] . $value . " ) )\n";
			$funcstring2 .= "	            returnval =  this->" . $this->tablename . "_Post" . $res['column_name'] . $value . "( \$this );\n";
			...
			$funcstring2 .= "                 this->ObserverNotify( \"" . $value . "\", \"" . $res['column_name'] . "\" );\n";
...
*/
	...
	$searchablestring .= ");\n";
	$prikeystring .= " */\n";
	$constructstring = "         void __construct( " . $constructorvar . " )\n";
		$constructstring .= "         {\n";
		$constructstring .= "         \tint iPtrSize;\n";
		$constructstring .= "         \tiPtrSize = strlen( \"" . $objectmeta['pretty_name'] . "\" );\n";
		$constructstring .= "         \tthis->pretty_name = (char*)malloc( iPtrSize + 1 );\n";
		$constructstring .= "         \tmemset( this->pretty_name, '0', iPtrSize + 1 );\n";
		$constructstring .= "         \tstrncpy( this->pretty_name, \"" . $objectmeta['pretty_name'] . "\", iPtrSize );\n";
		$constructstring .= "\n";
		$constructstring .= "         \tiPtrSize = strlen( \"" . $objectmeta['pretty_plural'] . "\" );\n";
		$constructstring .= "         \tthis->pretty_plural = (char*)malloc( iPtrSize + 1 );\n";
		$constructstring .= "         \tmemset( this->pretty_plural, '0', iPtrSize + 1 );\n";
		$constructstring .= "         \tstrncpy( this->pretty_plural, \"" . $objectmeta['pretty_plural'] . "\", iPtrSize );\n";
		$constructstring .= "\n";
		$constructstring .= "         \tiPtrSize = strlen( \"" . $objectmeta['pageheader'] . "\" );\n";
		$constructstring .= "         \tthis->pageheader = (char*)malloc( iPtrSize + 1 );\n";
		$constructstring .= "         \tmemset( this->pageheader, '0', iPtrSize + 1 );\n";
		$constructstring .= "         \tstrncpy( this->pageheader, \"" . $objectmeta['pageheader'] . "\", iPtrSize );\n";
		$constructstring .= "\n";
		$constructstring .= "         \tiPtrSize = strlen( \"" . $objectmeta['pagefooter'] . "\" );\n";
		$constructstring .= "         \tthis->pagefooter = (char*)malloc( iPtrSize + 1 );\n";
		$constructstring .= "         \tmemset( this->pagefooter, '0', iPtrSize + 1 );\n";
		$constructstring .= "         \tstrncpy( this->pagefooter, \"" . $objectmeta['pagefooter'] . "\", iPtrSize );\n";
		$constructstring .= "\n";
		$constructstring .= "         \tthis->Setquerytablename( \"" . $this->tablename . "\" );\n";
		$constructstring .= "         \tthis->Setclassname( \"" . $this->tablename . "\" );\n";
		//Set the passed in variables
		foreach( $constructorset as $vartoset )
		{
			$constructstring .= "         \tthis->Set$vartoset( " . $vartoset . " );\n";
		}
...
//		$funcstring .= "                 if ( isset( this->observers[00] ) )\n";	
//		$funcstring .= "                 \tforeach ( this->observers[00] as obs ) \n";
//		$funcstring .= "                 \t{\n";
//		$funcstring .= "                      \t\tobs->notify( event, msg );\n";
//		$funcstring .= "                 \t}\n"; 
//		$funcstring .= "	         return SUCCESS;\n";
...
function BuildRegister( $app )
{
        ...
        while( $row = mysql_fetch_array( $this->db->result ) )
        {
                ...
                $out .= "\t@include_once( '" . $row['table_name'] . ".cpp' );\n";
